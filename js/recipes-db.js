recipes = [ 
    ...
    {   "id": "O5", "title": "Garlic Focaccia", "category":"baking",
        ...
        "directions":[
            ...
            "!Focaccia",
            "Combine flour, salt, yeast, and water in a large bowl. Mix with hands or wooden spoon until no dry flour remains.",
            "Cover bowl tightly with plastic wrap, making sure that the edges are well sealed. Let rest on the countertop for at least 8 and up to 24 hours.",
            "Sprinkle top of dough with flour and transfer to a lightly floured work surface. Form into a ball by holding with well floured hands, and tucking dough underneath itself. Rotate until it forms a tight ball.",
            "Pour 2 Tbsp of oil in the bottom of a 12\" cast iron skillet or large cake pan. Transfer dough to pan, turn to coat in oil, and position seam-side-down. Using a flat palm, press the dough around the skillet, flattening slightly and spreading oil around bottom edges of the pan.",
            "Cover tightly with plastic wrap and let the dough sit at room temperature for 2 hours. After the first hour, adjust an oven rack to the middle position and preheat oven to 500F",
            "At the end of 2 hours, dough should mostly fill skillet. Use fingertips to press it around and fill every corner, popping any large bubbles that appear. Lift up one edge of dough to let any air bubbles underneath escape. Repeat, moving around the dough until there are no air bubbles underneath and the dough is evenly spread around the skillet.",
